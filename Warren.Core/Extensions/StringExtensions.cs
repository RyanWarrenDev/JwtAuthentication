...
namespace Warren.Core.Extensions
{
    public static class StringExtensions
    {
        public static int? ToInt(this string? value, int? defaultValue = null)
        {
            ...
            newValue = int.TryParse(value, out newValue) ? newValue : defaultValue.Value;
        ...
        public static int ToInt(this string? value, int defaultValue)
        {
            ...
            newValue = int.TryParse(value, out newValue) ? newValue : defaultValue;
        ...
        {
            var decbuff = UrlTokenDecode(value);
